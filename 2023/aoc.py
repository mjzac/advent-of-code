...
parser = argparse.ArgumentParser(description='''Helper tool to run Advent of Code programs. 
...
subprocess.run(['python', f'{args.day}/solution.py', f"{args.day}/{args.day}", f"{args.part}"], check=True, env=copy_env)
